...
<body>
    ...
    <div class="error-container">
        ...
        <div class="error-heading">Página Não Encontrada</div>
        <div class="error-message">
            <p>Oops! Parece que a página que você está tentando acessar não existe ou foi movida.</p>
            <p>Verifique se o endereço foi digitado corretamente ou tente voltar para a página inicial.</p>
        </div>
